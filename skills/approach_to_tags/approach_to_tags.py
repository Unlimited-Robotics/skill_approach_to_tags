...
class SkillApproachToTags(RayaFSMSkill):
    ...
    STATES_TIMEOUTS = {
            'READ_APRILTAG' :      
                    (NO_TARGET_TIMEOUT_STATE, ERROR_NO_TARGET_FOUND_READ_APRILTAG),
            'READ_APRILTAG_1' :      
                    (NO_TARGET_TIMEOUT_STATE, ERROR_NO_TARGET_FOUND_READ_APRILTAG_1),
            'READ_APRILTAGS_N' :   
                    (NO_TARGET_TIMEOUT_STATE, ERROR_NO_TARGET_FOUND_READ_APRILTAGS_N),
            'READ_APRILTAGS_FINAL_CORRECTION': 
                    (NO_TARGET_TIMEOUT_STATE, ERROR_NO_TARGET_FOUND_READ_APRILTAGS_FINAL_CORRECTION),
            'READ_APRILTAGS_FINAL': 
                    (NO_TARGET_TIMEOUT_STATE, ERROR_NO_TARGET_FOUND_READ_APRILTAGS_FINAL),
        }
